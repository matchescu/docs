...
% Document
\begin{document}
    \title{PyResolveMetrics: A Standards-Compliant, Theory-Consistent, and Efficient Approach to Entity Resolution Metrics}
    \author{\authorname{Andrei Olar\sup{1}\orcidAuthor{0000-0000-0000-0000}}
    \affiliation{\sup{1}Faculty of Computer Science, Babes-Bolyai University}
    \email{\{andrei.olar\}@ubbcluj.ro}
    }
    \keywords{Entity resolution,Metrics,Library,Open Source,Standards-Compliant,Theoretical Model,Efficient}
