...
\begin{document}
    ...
    One such condition is that probabilistic recall is always going to be
    ...
    Another invariant is that cluster precision is a good counterweight to
    ...
    This leads us to our third invariant: the Talburt-Wang Index and the cluster
