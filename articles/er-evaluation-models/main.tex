...
\]
    ...
    The model then deconstructs $X$ to two disjoint subsets: $M$ for pairs that
    ...
    comparison will also a vector denoted $\gamma \in \varGamma$, where
    ...
    think of them not merely as records, but as functions that transform the
    ...
    entity resolution tasks that use this model is determined by the definition
    ...
    \begin{itemize}
        ...
        \item \textbf{true negatives} as pairs in $U$ that belong in $U$, and
