...
We did not use the DBLP-Scholar because of practical reasons concerning the
...
\begin{table}[ht]
    ...
    \begin{tabular}{|l|l|l|l|}
        ...
        \hline
    \end{tabular}
    \caption{An example record of the `DG1' subset}
...
\begin{table}[ht]
    ...
    \begin{tabular}[b]{|l|l|l|}
        ...
        \hline
    \end{tabular}
    \caption{An example record of the `DG2' subset}
...
Running the experiments has also proven to be a source of insights into the
computational expenditure surrounding entity resolution itself and the
